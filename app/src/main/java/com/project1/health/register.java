...
public class register extends AppCompatActivity {
    ...
    EditText edUser,edEmail,edPassword,edConfirm;
    Button btn;
    TextView tv;
    String passwordhere;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edUser = findViewById(R.id.editTextRusername);
        edUser = findViewById(R.id.editTextRpassword);
        edPassword = findViewById(R.id.editTextRemail);
        edConfirm = findViewById(R.id.editTextRconfirmpassword);
        btn = findViewById(R.id.buttonRegister);
        tv = findViewById(R.id.textViewRalreadyacc);
